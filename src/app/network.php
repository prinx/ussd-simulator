            ...
            <div class="col-md-6 my-3">
                ...
                <form method="POST" action="">
                    <div class="form-field form-group mt-2">
                        <label class="text-primary" for="network">Network name<sup><small
                                       class="text-secondary">*</small></sup></label>
                        <input type="text" name="network" id="network" class="form-control" placeholder="Network name"
                               value="<?php echo $networkName ?? '' ?>" autofocus required>
                    </div>

                    <div class="form-field form-group" title="MNC">
                        <label class="text-primary" for="mnc">MNC<sup><small
                                       class="text-secondary">*</small></sup></label>
                        <input type="text" name="mnc" id="mnc" input="numeric" class="form-control" pattern="[0-9]{1,3}"
                               value="<?php echo $mnc ?? '' ?>" placeholder="MNC">
                    </div>

                    <div class="form-field form-group">
                        <label class="text-primary" for="network">Phone number patterns for this network <small>(one per
                                line)</small></label><br>
                        <textarea class="form-control" name="patterns" id="patterns" rows="3"
                                  placeholder="The pattern is used to automatically determine the network a number belongs to this network when you will be adding new numbers"><?php echo $patterns ?? '' ?></textarea>
                    </div>
    ...
    ?>
                <div class="card my-2 rounded-0 border-top-0 network-container">
                    <div class="card-header row">
                        <div class="text-primary col-6" title="Modify this network"><a
                               href="?network=<?php echo $networkName ?>"><?php echo $networkName ?></a>
                        </div>
                        <div class="col-4">
